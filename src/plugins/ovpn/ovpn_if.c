...
/* Device class TX function */
static uword
ovpn_if_tx (vlib_main_t *vm,
	    vlib_node_runtime_t *node __attribute__ ((unused)),
	    vlib_frame_t *frame)
{
  /* TODO: Implement TX function - encrypt and send packets */
